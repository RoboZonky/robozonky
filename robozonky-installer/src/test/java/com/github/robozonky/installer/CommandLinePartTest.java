...
class CommandLinePartTest {
    ...
    @Test
    void options() {
        final String firstOption = UUID.randomUUID()
            .toString();
        final String secondOption = UUID.randomUUID()
            .toString();
        final String thirdOption = UUID.randomUUID()
            .toString();
        final String firstValue = UUID.randomUUID()
            .toString();
        final String secondValue = UUID.randomUUID()
            .toString();
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(options.get(UUID.randomUUID()
                .toString()))
                .isNull();
            softly.assertThat(options.get(firstOption))
                .isEmpty();
            softly.assertThat(options.get(secondOption))
                .containsExactly(secondValue, firstValue);
            softly.assertThat(options.get(thirdOption))
                .containsExactly(firstValue, secondValue);
            softly.assertThat(clp.convertOptions())
                .isNotEmpty();
            softly.assertThat(clp.getJvmArguments())
                .isEmpty();
            softly.assertThat(clp.getProperties())
                .isEmpty();
            softly.assertThat(clp.getEnvironmentVariables())
                .isEmpty();
        });
    }
    ...
    @Test
    void properties() {
        final String firstProperty = UUID.randomUUID()
            .toString();
        final String secondProperty = UUID.randomUUID()
            .toString();
        final String firstValue = UUID.randomUUID()
            .toString();
        final String secondValue = UUID.randomUUID()
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(properties.get(UUID.randomUUID()
                .toString()))
                .isNull();
            softly.assertThat(properties.get(firstProperty))
                .isSameAs(firstValue);
            softly.assertThat(properties.get(secondProperty))
                .isSameAs(secondValue);
            softly.assertThat(clp.getJvmArguments())
                .isEmpty();
    ...
    void environmentVariables() {
        final String firstVariable = UUID.randomUUID()
            .toString();
        final String secondVariable = UUID.randomUUID()
            .toString();
        final String firstValue = UUID.randomUUID()
            .toString();
        final String secondValue = UUID.randomUUID()
        ...
        assertSoftly(softly -> {
            ...
            softly.assertThat(variables.get(UUID.randomUUID()
                .toString()))
                .isNull();
            softly.assertThat(variables.get(firstVariable))
                .isSameAs(firstValue);
            softly.assertThat(variables.get(secondVariable))
                .isSameAs(secondValue);
            softly.assertThat(clp.getJvmArguments())
                .isEmpty();
            softly.assertThat(clp.getOptions())
