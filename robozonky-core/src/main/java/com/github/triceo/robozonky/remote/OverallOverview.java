...
public class OverallOverview implements BaseEntity {

    private int totalInvestment, principalPaid, interestPaid, investmentCount, feesAmount, netIncome, principalLost;
