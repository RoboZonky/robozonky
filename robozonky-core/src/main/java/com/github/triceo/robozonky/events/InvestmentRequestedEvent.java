 ...
 */
public class InvestmentRequestedEvent implements Event {

    private final Investment investment;

    public InvestmentRequestedEvent(final Investment investment) {
        this.investment = investment;
    }

    /**
     * @return The investment to be made in the Zonky API.
     */
