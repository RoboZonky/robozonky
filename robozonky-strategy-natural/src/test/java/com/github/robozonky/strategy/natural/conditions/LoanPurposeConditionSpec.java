...
class LoanPurposeConditionSpec implements ConditionSpec<Purpose, LoanWrapper> {

    private AbstractEnumeratedCondition<Purpose> impl;

    @Override
    public AbstractEnumeratedCondition<Purpose> newImplementation() {
        this.impl = new LoanPurposeCondition();
        return impl;
    }
