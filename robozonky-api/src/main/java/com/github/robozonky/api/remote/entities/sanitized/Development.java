...
public interface Development {
    ...
    static Development sanitized(final RawDevelopment original) {
        return Development.sanitize(original).build();
    }
    ...
    static DevelopmentBuilder sanitize(final RawDevelopment original) {
