#!/bin/sh
ROBOZONKY_EXECUTABLE="robozonky-distribution-full-${project.version}.jar"
...
if [ -f $CUSTOM_JRE_LOCATION/$JAVA_EXECUTABLE ]; then
    JAVA_EXECUTABLE=$CUSTOM_JRE_LOCATION/$JAVA_EXECUTABLE
