...
Vygeneroval ${data.session.userAgent} v čase ${timestamp?datetime?iso_utc_ms} na základě systémové události vytvořené v
čase ${data.conception?datetime?iso_utc_ms}.
