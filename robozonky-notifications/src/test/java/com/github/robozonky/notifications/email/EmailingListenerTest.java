...
class EmailingListenerTest extends AbstractRoboZonkyTest {
    ...
    Stream<DynamicNode> listeners() throws MalformedURLException {
        ...
        return Stream.of(
                ...
                forListener(SupportedListener.INVESTMENT_SOLD, new InvestmentSoldEvent(i, MAX_PORTFOLIO)),
                ...
                forListener(SupportedListener.LOAN_NO_LONGER_DELINQUENT,
                            new LoanNoLongerDelinquentEvent(i, LocalDate.now(),
                                                            Collections.singletonList(mockCollectionNoEndDate()))),
                forListener(SupportedListener.LOAN_DEFAULTED,
                            new LoanDefaultedEvent(i, LocalDate.now(),
                                                   Collections.singletonList(mockCollectionNoNote()))),
                forListener(SupportedListener.LOAN_NOW_DELINQUENT,
                            new LoanNowDelinquentEvent(i, LocalDate.now(), Collections.emptyList())),
                forListener(SupportedListener.LOAN_DELINQUENT_10_PLUS,
                            new LoanDelinquent10DaysOrMoreEvent(i, LocalDate.now().minusDays(11),
                                                                Collections.emptyList())),
                forListener(SupportedListener.LOAN_DELINQUENT_30_PLUS,
                            new LoanDelinquent30DaysOrMoreEvent(i, LocalDate.now().minusDays(31),
                                                                Collections.emptyList())),
                forListener(SupportedListener.LOAN_DELINQUENT_60_PLUS,
                            new LoanDelinquent60DaysOrMoreEvent(i, LocalDate.now().minusDays(61),
                                                                Collections.emptyList())),
                forListener(SupportedListener.LOAN_DELINQUENT_90_PLUS,
                            new LoanDelinquent90DaysOrMoreEvent(i, LocalDate.now().minusDays(91),
                                                                Collections.emptyList())),
                forListener(SupportedListener.LOAN_REPAID, new LoanRepaidEvent(i, MAX_PORTFOLIO)),
                ...
                forListener(SupportedListener.INVESTMENT_PURCHASED,
                            new InvestmentPurchasedEvent(i, MAX_PORTFOLIO)),
                forListener(SupportedListener.SALE_OFFERED, new SaleOfferedEvent(i))
        );
    }
